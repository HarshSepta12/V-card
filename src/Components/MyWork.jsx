  ...
  return (
    <div className="container-sm">
      <div className="row text-center mx-auto w-100 text-light wid">
        ...
        <div
          className="col-sm-12 d-flex justify-content-center align-items-center gap-3 flex-wrap mb-5"
          data-aos="fade-left"
        ...
        >
          <div className="img-section">
            <img className="project-img" src={project7} alt="project10" />
            <div className="abs">
              <a
                href="https://second-place-frontend.vercel.app/"
                target="blank"
              >
                <RiShareCircleFill />
                <p>Live Preview</p>
          ...
          <div className="img-section">
            ...
            <div className="abs">
              <a
                href="https://crud-operation-in-react-js-beta.vercel.app/"
                target="blank"
              >
                <RiShareCircleFill />
                <p>Live Preview</p>
          ...
          <div className="img-section">
            <img className="project-img" src={project4} alt="project4" />
            <div className="abs">
          ...
          <div className="img-section">
            <img className="project-img" src={project5} alt="project5" />
            <div className="abs">
          ...
          <div className="img-section">
            <img className="project-img" src={project6} alt="project6" />
            <div className="abs">
